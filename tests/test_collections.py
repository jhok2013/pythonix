...
class TestDeq(TestCase):
    ...
    def test_get(self) -> None:
        ...
        self.assertIsInstance(self.deq.get(10).unwrap_other(), Nil)
    
    def test_pops(self) -> None:
        self.deq.clear()
        self.assertIsInstance(self.deq.pop().unwrap_other(), Nil)
        self.assertIsInstance(self.deq.popleft().unwrap_other(), Nil)
    
    def test_index(self) -> None:
        self.assertEqual(self.deq.index(1).unwrap(), 0)
        self.assertIsInstance(self.deq.index(10).unwrap_other(), Nil)
    ...
    def test_maxlen(self) -> None:
        self.assertIsInstance(self.deq.maxlen.unwrap_other(), Nil)
    
    def test_remove(self) -> None:
        self.assertEqual(self.deq.remove(1).q.popleft().q, 2)
        self.assertIsInstance(self.deq.remove(10).unwrap_other(), ValueError)
...
class TestDictPlus(TestCase):
    ...
    def test_get_item(self) -> None:
        ...
        self.assertIsInstance(self.d["world"].unwrap_other(), Nil)
    ...
    def test_pop(self):
        ...
        self.assertIsInstance(self.d.pop("world").unwrap_other(), Nil)

    def test_popitem(self):
        self.assertEqual(self.d.popitem().unwrap(), ("hello", "world"))
        self.assertIsInstance(self.d.popitem().unwrap_other(), Nil)
    ...
    def test_clear(self):
        self.d.clear()
        self.assertIsInstance(self.d.pop("hello").unwrap_other(), Nil)
